    ...
    return (
        <div className="text-white mx-4 mt-25 max-w-screen-2xl mx-auto font-[Nunito]">
            ...
            <section className="flex flex-col justify-between h-screen">
                ...
                <div >
                    <div>
                        <button onClick={gotolatestworks} className="relative z-20 bg-[#4595eb] ml-[50%] mb-[15%]  py-2 px-5 rounded font-extrabold bg-gradient-to-l from-[#1595b6] to-[#1f2667e6] hover:scale-110 ease-in-out duration:100 group cursor-pointer">
                            Latest Works
                            <svg
                                xmlns="http://www.w3.org/2000/svg"
                                version="1.1"
